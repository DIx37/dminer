...
logging.basicConfig(filename='dminer.log', encoding='utf-8', level=logging.DEBUG)
...
def screen(gpu_json, log_trex, log_gminer):
    ...
    print(f"DIx Miner v0.531    Время: {gpu_json['timestamp']}    Версия драйвера: {gpu_json['driver_version']}    Версия CUDA: {gpu_json['cuda_version']}")
